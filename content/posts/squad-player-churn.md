...
In this analysis of Premier League champions since 2004–05, I define players with more than five appearances but fewer than 20 starts as squad players. The starting season is chosen because it is the first combining José Mourinho’s arrival at Chelsea with the club’s spending spree, widely regarded as having altered the transfer market for good. That definition has two reasons behind it: a player earns a medal only if he makes at least five appearances, and in a 38-game season only the starters would be expected to play more than half the games.
...
{{< note href="https://github.com/tejas-kale/experiments/blob/main/football-squad-player-churn/squad_player_churn.py" >}}Marimo notebook{{< /note >}}
