...
As can be seen in the chart below, most flags have 2-4 colours. I was surprised to find no unicolour flag in this dataset. Also, when a flag contains a crest or a coat of arms, its colour count is often 6 or more.

![Distribution of colours in national flags]({{< relURL "charts/flag-colours.png" >}})
