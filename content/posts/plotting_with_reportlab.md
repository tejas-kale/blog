...
If you wish to explore ReportLab and compare its performance to other plotting packages, check out [this notebook](https://github.com/tejas-kale/blog/blob/main/notebooks/plotting_with_reportlab/pdf_generation_benchmark.ipynb).